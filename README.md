# gurleenvirk-analytics-portfolio
This repository showcases applied analytics, machine learning, and causal inference projects using real-world datasets and business-driven problem framing. Across domains (crypto, healthcare, robotics, public policy), I focus on building reproducible analyses and communicating results in an executive-ready way.

### 1. Stablecoin Ecosystem Dashboard (SQL, Dune Analytics)
- Built end-to-end SQL analytics pipelines on blockchain data
...
## Core strengths
- **Business translation:** turning code, models, and metrics into decisions stakeholders can act on  
- **Causal inference:** RCTs and regression discontinuity for credible impact estimation  
- **Analytics engineering:** clean pipelines, reproducible workflows, and well-documented outputs  
- **Storytelling with data:** visuals + structured narratives built for non-technical audiences  
